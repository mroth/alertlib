...
class Alert(object):
    ...
    def _slack_payload(self, channel,
                       simple_message=False, attachments=None,
                       link_names=True, unfurl_links=False, unfurl_media=True,
                       icon_url=None, icon_emoji=":crocodile:",
                       sender='AlertiGator'):
        ...
        if icon_emoji:
            payload.update({"icon_emoji": icon_emoji})
        ...
        if simple_message:                          # "simple message" case
            ...
            if self.summary:
                attachment.update({"pretext": self.summary})
